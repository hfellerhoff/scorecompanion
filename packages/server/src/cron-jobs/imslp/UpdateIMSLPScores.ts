...
export const updateIMSLPScores = async () => {
  ...
  const batchSize = 1; // Amount of promises to evaluate at the same time. A large batch size risks a request-timeout if they cannot be evaluated quickly enough.
